package pageObjects.hw6.center;
...
public class RightSection {
    ...
    private SelenideElement logPanel;
    ...
    public void checkLoggedNameAndStatusCorrect(LogItem... logItems) {
        ElementsCollection logRows = logPanel.$$("li");
    ...
    public void checkLogRowText(int qty, String logText) {
        ElementsCollection logRows = logPanel.$$("li");
        logRows.filter(Condition.text(logText)).shouldHaveSize(qty);
    }
}
